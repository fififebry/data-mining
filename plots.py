...
def app(df):
    ...
    prediction = st.multiselect("Select x-axis values:", ("speedometer", "enginesize", "maks_kecepatan", "peakrpm"))
    ...
    if ("Histogram" in plot_type):
        ...
        hist_column = st.selectbox("Select the column to create its histogram", ("speedometer", "enginesize", "horsepower", "peakrpm"))
        # Plot the chart.
        fig = plt.figure(figsize=(12, 5))
    ...
    if ("Box Plot" in plot_type):
        ...
        # Take column from user.
        box_column = st.selectbox("Select the column to create its boxplot", ("speedometer", "enginesize", "horsepower", "peakrpm"))
        # Plot the chart.
